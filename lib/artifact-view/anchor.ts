...
// ---------------------------------------------------------------------------
// LCS-ops 顺序渲染（第七轮·第二轮纠偏，D-R7B-01）：取代 buildSegments 的子序列重锚。
// 对 PendingChange 的 oldContent→newContent 跑同一 LCS，按真实顺序产出渲染段——
// 改动 run 天然落在前后 equal 上下文之间，不存在「锚不到」（无 unaligned 概念）。
// ---------------------------------------------------------------------------
