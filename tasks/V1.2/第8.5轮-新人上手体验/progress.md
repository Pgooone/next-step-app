...
| **T2** | 流水线 UI N1/N2/**N3**/N4（N2 hover 闪烁修〔**真根因订正**〕+ 两浮层边界感知/内部滚；**N3 board 终态自动刷会话·补回**） | small→偏中 · 批次1 | 🟡 审计订正完·待复审 |
...
| **T4** | 文案中文化（C2/C12 短语+打字机 90ms·Array.from / C7 / C11 / C14 集中扫〔**EXPLORER 确实存在·纳入译表**〕） | small · 批次1 | 🟡 审计订正完·待复审 |
