...
- **状态**：调研 + 方案已成型，**待用户细化需求后开工**（下一步 brainstorm 对齐 MVP 裁剪范围）。
...
V1.1 侧（根 `CLAUDE.md`、`next-step-V1.1/README.md`、`next-step-V1.1/docs/QA/00-索引.md`）已标注「已迁至 V1.2」，不再承接。调研留痕原文随工作副本复制在 `../QA/开发/通用多Agent配置-sf-mini反推.md`（V1.1 时期产物，作设计输入参考）。
